...
class OrderProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_product" do
    assert_difference('OrderProduct.count') do
      post order_products_url, params: { order_product: { order_id: @order_product.order_id, product_id: @order_product.product_id, quntity: @order_product.quntity } }
    end
  ...
  test "should update order_product" do
    patch order_product_url(@order_product), params: { order_product: { order_id: @order_product.order_id, product_id: @order_product.product_id, quntity: @order_product.quntity } }
